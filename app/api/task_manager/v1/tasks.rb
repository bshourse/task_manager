module TaskManager
  module V1
    class Tasks < Grape::API
      version 'v1', using: :path # here i specify the version of api
      format :json # here i tell our api that we expect and use only json
      prefix :api # with this prefix I am accessing entry points /api in routes i set TaskManager::Base => '/'
      ...
      resource :tasks do
        ...
        params do
          ...
          requires :status, type: Integer,
                            except_values: { value: [1, 2, 3, 4], message: 'when you create a task should be only: 0 - Open' }
        ...
        params do
          ...
          requires :description, type: String
          requires :status, type: Integer,
                            values: { value: [0, 1, 2, 3, 4], message: 'when you update a task should be 0 - Open | 1 - in_progress | 2 - resolved | 3 - reopen | 4 - closed' }
